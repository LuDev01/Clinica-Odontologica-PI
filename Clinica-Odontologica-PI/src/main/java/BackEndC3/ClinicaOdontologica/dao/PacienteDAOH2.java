...
public class PacienteDAOH2 implements iDao<Paciente> {
    ...
    private static final String SQL_INSERT="INSERT INTO PACIENTES(NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, DOMICILIO_ID,ODONTOLOGO_ID) VALUES(?,?,?,?,?,?)";
    ...
    public Paciente buscarPorString(String string) {
        ...
        DomicilioDAOH2 daoAux= new DomicilioDAOH2();
        OdontologoDAOH2 daoAuxOdo= new OdontologoDAOH2();
        try{
            connection=BD.getConnection();
            ...
            while(rs.next()){
                domicilio= daoAux.buscarPorId(rs.getInt(6));
                odontologo=daoAuxOdo.buscarPorId(rs.getInt(8));
